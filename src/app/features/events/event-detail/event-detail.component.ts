      ...
      <div *ngIf="!loading && event">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
           <mat-card class="p-4 bg-blue-50 border-none shadow-sm">
             ...
             <div class="text-2xl font-black text-blue-900">{{ participants.length }}</div>
           </mat-card>
                ...
                <mat-card class="p-6 border shadow-sm h-fit">
                  ...
                  <div class="space-y-4">
                    <div class="flex flex-col">
                      <span class="text-[10px] text-slate-400 font-bold uppercase m-0">Date de début</span>
                      <span class="text-sm font-medium">{{ event.date | date:'long' }}</span>
                    </div>
                    <div class="flex flex-col">
...
export class EventDetailComponent implements OnInit {
    ...
    deleteEvent(): void {
        ...
        this.notificationService.info('Fonctionnalité de suppression à venir');
    }
}
